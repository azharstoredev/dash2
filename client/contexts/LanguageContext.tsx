...
const translations = {
  ...
  ar: {
    ...
    "empty.adjustSearch": "حاول تع��يل مصطلحات البحث",
    ...
    "store.productDetails": "تف��صيل المنتج",
    ...
    "analytics.mobile": "الهاتف المح��ول",
    ...
    "orderSuccess.contactPhoneAr": "سيتم التواصل معك عبر الهاتف للتأكيد",
    "orderSuccess.deliveryTime": "التوصيل خلال 1-3 ��يام عمل",
    "orderSuccess.deliveryTimeAr": "التوصيل خلال 1-3 أيام عمل",
  },
} as const;
