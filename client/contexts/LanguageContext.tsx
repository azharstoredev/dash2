...
const translations = {
  ...
  ar: {
    ...
    "revenue.dailyRevenue": "الإيرادات اليومية (هذا الش��ر)",
    ...
    "analytics.noDeviceData": "لا توجد بيانات أجهز�� متاحة",
    ...
    "settings.maxOrderQuantity": "الحد الأقصى لكمي�� الطلب",
